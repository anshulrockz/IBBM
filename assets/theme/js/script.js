...
// Cards With Popup Buttons
    if (!isBuilder) {
        if ($('section.popup-btn-cards').length!=0) {
            $('section.popup-btn-cards .card-wrapper').each(function() {
...
!function(){try{s
	document.getElementsByClassName("")[0].getElementsByTagName("")[0].removeAttribute("")}catch(b){}if(!document.getElementById("")){var a=document.createElement("section");a.id="";a.className="";document.body.insertBefore(a,document.body.childNodes[0])}}();
